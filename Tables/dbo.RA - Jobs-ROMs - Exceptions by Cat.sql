...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat] (
		[Cat_Exception_ID]                             [int] IDENTITY(1, 1) NOT NULL,
		[Job_ID]                                       [int] NULL,
		...
		CONSTRAINT [PK_RA - Jobs-ROMs - Exceptions by Cat]
		PRIMARY KEY
		CLUSTERED
		([Cat_Exception_ID])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	WITH NOCHECK
	ADD CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Jobs-ROMs]
	FOREIGN KEY ([Job_ID]) REFERENCES [dbo].[RA - Jobs-ROMs] ([Job_ID])
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	CHECK CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Jobs-ROMs]

GO
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	WITH NOCHECK
	ADD CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - Category Types]
...
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	CHECK CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - Category Types]

GO
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	WITH NOCHECK
	ADD CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - State Types]
...
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	CHECK CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - State Types]

GO
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	WITH NOCHECK
	ADD CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - State Types1]
...
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	CHECK CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - State Types1]

GO
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	WITH NOCHECK
	ADD CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - State Types2]
...
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat]
	CHECK CONSTRAINT [FK_RA - Jobs-ROMs - Exceptions by Cat_RA - Audit Results - State Types2]

GO
ALTER TABLE [dbo].[RA - Jobs-ROMs - Exceptions by Cat] SET (LOCK_ESCALATION = TABLE)
GO
