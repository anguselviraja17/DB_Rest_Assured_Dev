...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Staging-TM-1-Material] (
...
GO
ALTER TABLE [dbo].[Staging-TM-1-Material]
	ADD
	CONSTRAINT [DF__TM-1-Mate__Entry__408F9238]
	DEFAULT (getdate()) FOR [EntryDate]
GO
CREATE UNIQUE NONCLUSTERED INDEX [ID]
	ON [dbo].[Staging-TM-1-Material] ([ID])
	ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [BillID]
	ON [dbo].[Staging-TM-1-Material] ([BillID])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[Staging-TM-1-Material] SET (LOCK_ESCALATION = TABLE)
GO
