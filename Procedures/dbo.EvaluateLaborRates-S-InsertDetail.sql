...
-- =============================================
CREATE PROCEDURE [dbo].[EvaluateLaborRates-S-InsertDetail] 
...
(([RA - Rest Bills Unscrubbed-Labor-Cost].Role_Abbreviation) Is Null));
    ...
    -- Insert into Audit Details from Unscrubbed Labor By Role Name and look for Successfull Rate Check
...
'Role found-Rate is NOT higher than Industry Range: '+[RA - Rest Bills Unscrubbed-Labor-Cost].[Role_Name] AS RoleDesc,
...
FROM [RA - Rest Bills Unscrubbed-Labor-Cost] INNER JOIN [RA - Industry - Role Range plus Alias - Max Rate] ON [RA - Rest Bills Unscrubbed-Labor-Cost].Role_Name = [RA - Industry - Role Range plus Alias - Max Rate].Industry_Role_Name_Alias
GROUP BY 
[RA - Rest Bills Unscrubbed-Labor-Cost].Rest_Bill_ID, 'Role found-Rate is NOT higher than Industry Range: '+[RA - Rest Bills Unscrubbed-Labor-Cost].[Role_Name], 
[RA - Rest Bills Unscrubbed-Labor-Cost].Role_Hourly_Rate, [RA - Rest Bills Unscrubbed-Labor-Cost].Job_ID,
[RA - Rest Bills Unscrubbed-Labor-Cost].Rest_Co, 
IIf(([Role_Hourly_Rate]-[Quart3OfRole_High_Rate_Day]*@AllowablePercentOver)<=0,'S','F'),
[RA - Rest Bills Unscrubbed-Labor-Cost].Role_Hourly_Rate
...
((IIf(([Role_Hourly_Rate]-[Quart3OfRole_High_Rate_Day]*@AllowablePercentOver)<=0,'S','F'))='S'));
